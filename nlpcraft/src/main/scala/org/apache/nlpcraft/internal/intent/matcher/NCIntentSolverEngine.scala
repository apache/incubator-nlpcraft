 ...
 */
case class NCIntentSolverEngine(dialog: NCDialogFlowManager) extends LazyLogging:
    /**
     ...
     * @return
     */
    def solve(ctx: NCContext, intents: Map[NCIDLIntent, NCIntentMatch => NCResult]): List[NCIntentSolverResult] =
