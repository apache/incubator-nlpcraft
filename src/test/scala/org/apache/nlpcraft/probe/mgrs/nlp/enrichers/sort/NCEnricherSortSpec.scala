...
//                    usr(text = "A", id = "A"),
//                    usr(text = "B", id = "B"),
//                    srt(text = "classify", subjNotes = Some(Seq("A", "B")), subjIndexes = Some(Seq(0, 1)))
//                )
//            ),
//            _ ⇒ checkAll(
//                "D classify",
...
//                "sort by A",
//                Seq(
//                    srt(text = "sort by", subjNotes = None, subjIndexes = None, byNotes = Some(Seq("A")), byIndexes = Some(Seq(1)), asc = None),
//                    usr(text = "A", id = "A")
//                )
//            )
//        )
